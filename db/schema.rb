...
ActiveRecord::Schema[7.1].define(version: 2025_05_23_060338) do
  ...
  create_table "applications", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["job_role_id"], name: "index_applications_on_job_role_id"
  ...
  create_table "job_roles", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_job_roles_on_company_id"
  end
  ...
  add_foreign_key "applications", "job_roles"
  add_foreign_key "applications", "students"
  add_foreign_key "job_roles", "companies"
end
